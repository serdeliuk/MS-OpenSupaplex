...
class fuse(Screen, ServiceStopScreen):
	...
	skin="""
		<screen name="supa" position="0,0" size="1,1" title="opensupaplex" backgroundColor="black" flags="wfNoBorder">
	...
	def __init__(self, session):
		...
		if ptr is not None:
		    ...
		    self["pic"].show()
		self.picload.getThumbnail('/usr/lib/enigma2/python/Plugins/Extensions/MS-OpenSupaplex/opensupaplex.png', 100, 100)
		self["pic"].show()
	...
	def runEmu(self):
		...
		cmd = "cd /usr/lib/enigma2/python/Plugins/Extensions/MS-OpenSupaplex/game/; ./opensupaplex >> /tmp/opensupaplex.txt 2>&1;"
